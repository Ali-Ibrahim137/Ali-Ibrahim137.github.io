...
# Conclusion
In this article we started by giving a motivation problem, discussed different solutions to the problem and started to improve the solution, we ended up by talking about monotonic queue and how to use it to solve the problem.The code for this problem is available [here](https://github.com/Ali-Ibrahim137/Competitive-Programming/blob/master/Articles/monotonic%20queue.cpp).
